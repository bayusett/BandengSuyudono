                            ...
                            <form action="{{route('orders.update', $item->id)}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="payment_status" class="form-control">
                                            <option value="{{$item->id}}" selected>{{$item->payment_status}}</option>
                                ...
                                <div class="row">
                                    <div class="col text-left">
                                        ...
                                        <button type="submit" class="btn btn-success px-5" disabled>Save</button>
                                        @else
                                        <button type="submit" class="btn btn-success px-5" onclick="return confirm('Apakah Kamu yakin?')">Save</button>
                                        @endif
                                    </div>
                                </div>
                            </form>
                            ...
                            <form action="{{route('orders.update', $item->id)}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row justify-content-beetwen">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            @if ($oders->notes == 'diambil')
                                            <select name="transaction_status" class="form-control">
                                                <option value="{{$item->id}}" selected>{{$item->transaction_status}}</option>
                                                <option disabled>-------</option>
                                                <option value="PENDING">PENDING</option>
                                ...
                                <div class="row">
                                    <div class="col text-left">
                                        ...
                                        <button type="submit" class="btn btn-success px-5" onclick="return confirm('Apakah Kamu yakin?')">Save</button>
                                        @endif
                                        <a href="{{route('orders.index')}}" class="btn btn-danger px-5">Kembali</a>
                                    </div>
                                </div>
                                @endif
                            </form>
