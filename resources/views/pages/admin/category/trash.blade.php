...
@section('title')
Halaman Utama Admin Trash Kategori
@endsection
@section('content')
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Trash Kategori Dashboard</h1>
                </div>
                <!-- /.col -->
            </div>
            <!-- /.row -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="mb-2 d-flex">
                                <form action="{{route('trash.deletes')}}" method="POST">
                                    @csrf
                                ...
                                <a href="{{route('trash.restore')}}" class="btn btn-info btn-xs ml-2">
