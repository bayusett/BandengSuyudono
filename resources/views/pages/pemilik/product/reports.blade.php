...
@section('title')
Halaman Utama Pemilik Laporan Produk
@endsection
@section('content')
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Dashboard Laporan Produk</h1>
                </div>
                <!-- /.col -->
            </div>
            <!-- /.row -->
        ...
        <div class="dashboard-content">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{route('generateproduk')}}" method="POST">
                                @csrf
                                ...
                                <div class="input-group mb-3 justify-content-center">
                                    ...
                                    <a href="{{route('generateprodukall')}}" target="_blank" class="btn btn-danger ml-2">Cetak semua</a>
                                </div>
                            </form>
                        </div>
                    </div>
