                ...
                <div class="col-md-9">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endif
                            <form id="locations" action="{{route('profile-pemilik.edit')}}" method="POST" enctype="multipart/form-data">
                                @method('PUT')
                                @csrf
                                <div class="row">
                                    <div class="col-md-4">
                                ...
                                <div class="row">
                                    <div class="col text-right">
                                        ...
                                        <a href="{{route('pemilik-dashboard')}}" class="btn btn-danger px-5">Kembali</a>
                                    </div>
                                </div>
                            </form>
                        </div>
...
<script>
    ...
    $('#admin_images').ijaboCropTool({
        ...
        processUrl: '{{ route("pemilikUpdatePicture") }}',
