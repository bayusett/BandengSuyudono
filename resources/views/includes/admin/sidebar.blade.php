       ...
       <div class="sidebar">
           ...
           <nav class="mt-2">
               ...
               with font-awesome or any other icon font library -->
                   ...
                   <li class="nav-item">
                       <a href="{{route('kustomer.index')}}" class="nav-link {{(request()->is('admin/kustomer*')) ? 'active' : ''}}">
                           <i class="nav-icon fas fa-user"></i>
                           <p>Customer</p>
                       </a>
                   </li>
                   ...
                   <li class="nav-item">
                       ...
                       <ul class="nav nav-treeview">
                           <li class="nav-item">
                               <a href="{{route('dataproduks')}}" class="nav-link">
                                   <i class="far fa-circle nav-icon"></i>
                                   <p>Laporan Produk</p>
                               </a>
                           </li>
                       ...
                       <ul class="nav nav-treeview">
                           <li class="nav-item">
                               <a href="{{route('data.customers')}}" class="nav-link">
                                   <i class="far fa-circle nav-icon"></i>
                   ...
                   <hr />
                   <li class="nav-item">
                       <a href="{{route('profile-admin.edit')}}" class="nav-link">
                           <i class="nav-icon fas fa-user"></i>
                           <p>Profile</p>
                       </a>
                   </li>
                   <li class="nav-item">
                       <a href="{{route('password.edits')}}" class="nav-link {{(request()->is('admin/password*')) ? 'active' : ''}}">
